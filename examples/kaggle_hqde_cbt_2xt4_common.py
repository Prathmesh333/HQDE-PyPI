"""
Kaggle-ready HQDE + DeBERTa utilities for CBT cognitive-distortion datasets.

This module is intentionally notebook-safe: no argparse, no CLI parsing, and
no hidden Jupyter arguments to handle. Dataset-specific files import this module
and provide only their dataset loader.
"""
